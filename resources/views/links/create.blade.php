...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white">Create Short Link</h1>
            <p class="text-gray-400 mt-2">Shorten your long URLs and start tracking clicks instantly</p>
        </div>

        <!-- Main Form Card -->
        <div class="bg-gray-800 rounded-lg border border-gray-700 shadow-xl p-6 md:p-8">
            <form action="{{ route('links.store') }}" method="POST" id="createLinkForm">
                @csrf
                
                <!-- Original URL -->
                <div class="mb-6">
                    <label for="original_url" class="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" 
                               ...
                               class="w-full pl-10 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('original_url') border-red-500 @enderror"
                               required
                               autofocus>
                    </div>
                    @error('original_url')
                    ...
                    <p class="mt-2 text-sm text-gray-400">
                        <span class="text-blue-400">💡 Tip:</span> Paste any valid URL (http:// or https://)
                    </p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('title') border-red-500 @enderror">
                    @error('title')
                        <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Custom Code -->
                    <div>
                        <label for="custom_code" class="block text-sm font-medium text-gray-300 mb-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full pl-32 pr-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('custom_code') border-red-500 @enderror">
                        </div>
                        @error('custom_code')
                            <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-2 text-sm text-gray-400">
                            <span class="text-blue-400">🔑</span> 4-20 characters (letters and numbers only)
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" 
                               ...
                               class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('expires_at') border-red-500 @enderror">
                        @error('expires_at')
                            <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-2 text-sm text-gray-400">
                            <span class="text-blue-400">⏰</span> Leave blank for permanent link
                        </p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div id="advancedOptions" class="hidden mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-400">Separate tags with commas</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="notes" 
                                      ...
                                      class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-700">
                    ...
                    <a href="{{ route('links.index') }}" 
                       class="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 text-center">
                        Cancel
                    </a>
                </div>
            </form>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-gray-800/50 rounded-lg border border-gray-700 p-4">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-white font-semibold">Track Every Click</h4>
            ...
            <div class="bg-gray-800/50 rounded-lg border border-gray-700 p-4">
                <div class="flex items-start">
                    <div class="text-2xl mr-3">🔒</div>
                    <div>
                        <h4 class="text-white font-semibold">Security First</h4>
                        <p class="text-gray-400 text-sm mt-1">
            ...
            <div class="bg-gray-800/50 rounded-lg border border-gray-700 p-4">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-white font-semibold">Never Expires</h4>
                        <p class="text-gray-400 text-sm mt-1">
        ...
        @auth
            ...
            @if($recentLinks->count() > 0)
                <div class="mt-8 bg-gray-800/30 rounded-lg border border-gray-700 p-4">
                    <h4 class="text-white font-semibold mb-3">📌 Your Recent Links</h4>
                    <div class="space-y-2">
