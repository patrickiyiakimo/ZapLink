{{-- resources/views/welcome/partials/features.blade.php --}}
{{-- 
    Features Section
    Highlights the key features of ZapLink
--}}
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 max-w-5xl mx-auto">
    ...
    <div class="bg-gray-50 p-6 border border-gray-200 hover:border-blue-500 transition duration-300">
